...
export interface StepRichContent {
  ...
  /** QA health score */
  qaHealth?: number | undefined;
  /** PR link */
  prLink?: string;
  /** Deploy summary */
  deploySummary?: string | undefined;
}
