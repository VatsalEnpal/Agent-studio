...
### 1. [DONE] Workflow Definition Schema + Validation
...
### 2. [DONE] Reconcile WsMessage Types + Add Workflow Events
...
### 3. [DONE] CommandRunner Interface + Mock
...
### 5. [DONE] Executor: Agent Step Execution
...
### 6. [DONE] Executor: Pre-Execution Validation
...
### 9. [DONE] Executor: Timeout + Cancellation
...
### 10. [DONE] Executor: Nested Agent Groups
...
### 12. [DONE] Workflow Registry CRUD + Disk Persistence
...
### 13. [DONE] API Routes for Workflows
...
### 14. [DONE] Server Restart Recovery
...
### 15. [DONE] Rate Limit Detection + Auto-Retry
...
### 16. [DONE] Zustand Store for Workflows
...
### 17. [DONE] Workflow List in Sidebar
...
### 18. [DONE] Create Workflow Dialog — Step 1+2 (Define + Pipeline)
...
### 19. [DONE] Create Workflow Dialog — Step 3+4 (Trigger + Preview)
...
### 20. [DONE] Workflow Detail — Timeline with Gates and Loops
...
### 21. [DONE] Workflow Detail — Nested Agent Groups (Expandable)
...
### 24. [DONE] Import Existing Sprint as Watch-Mode Workflow
...
### 25. [DONE] Settings > Automations Tab
...
### 27. [DONE] Execution Errors — Crash, Timeout, Missing Output
...
### 28. [DONE] Execution Errors — Rate Limit, Server Restart, Agent Conflict
...
### 29. [DONE] Execution Errors — Graceful Degradation + Edge Cases
...
### 30. [DONE] Boundary Tests — Small Workflows
...
### 31. [DONE] Boundary Tests — Large + Unusual Workflows
...
### 32. [DONE] Backward Compatibility Deep Test
