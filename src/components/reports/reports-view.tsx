        ...
        <div className="text-center space-y-4 max-w-sm">
          ...
          <div>
            ...
            <p className="text-xs text-text-tertiary leading-relaxed">
              {hasAgentSystem
                ? "Configure automations in Settings to generate reports on a schedule. Reports will appear here for review."
                : "Reports are generated by automated sprints and the PMO agent. Set up an agent system to get started."}
            </p>
          </div>
          {!hasAgentSystem && (
            <button
